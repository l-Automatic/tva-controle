...
export {
  ...
  type ParametresPortesObligatoires,
  type EtatPortesObligatoires,
} from './portesObligatoires.js';
export {
...
export {
  ...
  type ParametresVerificationFraisVehicule,
} from './verifierFraisVehiculeLegere.js';
export {
...
export {
  ...
  type ParametresVerificationCadeauClient,
} from './verifierCadeauClientLegere.js';
export {
