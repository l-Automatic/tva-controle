...
import { Fuel, Gift, Landmark, Package, ShoppingCart, Wrench, X } from 'lucide-react';
...
const CHOIX = [
  ...
  { cle: 'comptes_immobilisation', libelle: 'Immobilisation', Icone: Landmark },
] as const;
...
// ajoutée en v6, 6ᵉ catégorie "immobilisation" ajoutée en v9). Fermer sans
// tout traiter est normal : les comptes non traités réapparaîtront au
// prochain cycle.
